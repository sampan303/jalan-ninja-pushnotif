      ...
      <main className="admin-content">
        <div className="admin-hero">
          ...
          <div className="hero-actions">
            <button className="btn-primary" onClick={() => setActiveTab('notifications')}>Kirim Notifikasi</button>
            <button className="btn-ghost" onClick={() => setActiveTab('settings')}>Edit Pengaturan</button>
          </div>
        </div>
